...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
    expect(multiply(15,85)).to eq(1275)
  end
...
describe "#power" do
  it "raises one number to the power of another number" do
    expect(power(5,10)).to eq(9765625)
  end

  it "when raising to the power of 1, the same number should return" do
    expect(power(5,1)).to eq(5)
  end

  it "when raising to the 0th power, 1 should return" do
